          ...
          <div className="flex justify-between">
            {RARITIES.map((r) => (
              <button
                key={r}
                onClick={() => setRarity(r)}
                className={`${paddingMap[r] || "px-3"} px-3 py-1 rounded-lg text-xs font-semibold transition-all ${
                  rarity === r
          ...
          <div className="flex justify-between">
            {ELEMENTS.map((e) => (
              <button
                ...
                className={`${elementPaddingMap[e] || "px-3"} px-3 py-1 rounded-lg text-xs font-semibold transition-all ${
                  element === e
                    ? "bg-gradient-to-b from-[#0144BD] to-[#192871] text-white"
                    : "bg-gradient-to-b from-[#0e1e4a] to-[#090f28] text-[#8a9fc8] hover:bg-[#1e3a6e]/60"
                }`}
