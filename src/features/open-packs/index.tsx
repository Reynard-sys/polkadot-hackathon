...
const DESKTOP_BUTTONS: {
  ...
  {
    type: "standard",
    src: "/assets/desktop-x10-btn.svg",
    alt: "Open x10",
    href: undefined,
  },
...
export default function OpenPacks() {
  ...
  const { openPack, isOpening, result, error, reset, simMode } =
    usePackOpening();
      ...
      <div className="flex flex-col lg:hidden max-w-sm mx-auto pt-20 px-4 gap-5 pb-28">
        ...
        >
          ...
          <p className="text-white/60 text-sm">
            Standard · 0.001&nbsp;|&nbsp;Premium · 0.0018&nbsp;|&nbsp;Ultra ·
            0.0025 WND
          </p>
          ...
          {simMode && !walletConnected && (
            <div className="flex items-center justify-between mt-1">
              <p className="text-green-400 text-xs">
                🎲 No wallet needed — open instantly!
              </p>
              <button
                onClick={openPicker}
        ...
        >
          ...
          {error && (
            <div className="bg-red-900/40 border border-red-500/40 rounded-lg px-4 py-2 text-red-300 text-sm flex items-center justify-between">
              ...
              <button
                onClick={reset}
                className="text-xs underline opacity-70 ml-2"
              >
                Dismiss
              </button>
            </div>
