...
export default function TournamentCard({
    ...
    return (
        <div className="bg-[#1E2139] rounded-2xl p-6 pl-4 lg:pl-10 shadow-md border border-[#040825]">
            {/* Header */}
            ...
            <button
                ...
                className="relative w-full h-[80px] flex items-center justify-center hover:opacity-90 transition-opacity"
            >
                <svg
                ...
                <span className="relative z-10 text-white font-bold text-sm lg:text-lg tracking-wide pb-3 lg:pb-1.5">
