...
export default function TournamentFeature() {
    ...
    const [viewingRankingsFor, setViewingRankingsFor] = useState<number | null>(null);
    ...
    return (
        <div className="bg-transparent font-sans py-10">
            {/* Mobile Banner */}
            <div className="lg:hidden relative w-full p-4 pt-24">
                <Image
            ...
            {/* Desktop Header */}
            <div className="hidden lg:block bg-transparent pt-16 pb-0 w-full">
            ...
            {/* Main Content */}
            <div className="max-w-3xl mx-auto p-4 pb-24 lg:p-0 lg:py-12">

                {/* Navigation Tabs */}
                <div className="grid grid-cols-4 gap-2 lg:gap-5 w-full bg-gradient-to-b from-[#0144BD] to-[#192871] rounded-2xl p-2 mb-8 lg:max-w-6xl lg:mx-auto">
                    {TABS.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    ...
                                    lg:py-3 text-sm font-bold rounded-xl
                ...
                {activeTab === "Online Tournaments" ? (
                    <div className="flex flex-col space-y-10 lg:space-y-3 lg:max-w-6xl lg:mx-auto">
